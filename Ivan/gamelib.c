...
//tipo imprevisto
  if ((*Pc)-> imprevisto == nessun_imprevisto) {
        (*fam)-> serbatoio_energia = (*fam)-> serbatoio_energia;
        (*fam)-> serbatoio_raccolta = (*fam)-> serbatoio_raccolta;
      }
  else if ((*Pc)-> imprevisto == crollo) {
    printf("C'è stato un crollo: consumi 1 punto energia per liberarti dalle macerie\n");
    (*fam)-> serbatoio_energia = (*fam)-> serbatoio_energia - 1;
    (*fam)-> serbatoio_raccolta = (*fam)-> serbatoio_raccolta;
  }
  else {
...
// tipo caverna
  if ((*Pc)-> tipo_caverna == normale) {
    (*fam)-> serbatoio_energia = (*fam)-> serbatoio_energia;
    (*fam)-> serbatoio_raccolta = (*fam)-> serbatoio_raccolta;
  }
  else if ((*Pc)-> tipo_caverna == speciale) {
  ...
  //else
    ...
    //quantità melassa
  if ((*Pc)-> melassa == nessuna) {
    (*fam)-> serbatoio_energia = (*fam)-> serbatoio_energia;
    (*fam)-> serbatoio_raccolta = (*fam)-> serbatoio_raccolta;
  }
  else if ((*Pc)-> melassa == poca) {
    int scelta;
    ...
    break;
      case 2:
        (*fam)-> serbatoio_energia = (*fam)-> serbatoio_energia;
        (*fam)-> serbatoio_raccolta = (*fam)-> serbatoio_raccolta +1;
    break;
    default:
        printf("Comando non valido\n");
      }
    ...
    switch (scelta2) {
    case 1:
        (*fam)-> serbatoio_energia = (*fam)-> serbatoio_energia + 3;
        (*fam)-> serbatoio_raccolta = (*fam)-> serbatoio_raccolta;
    break;
    case 2:
        (*fam)-> serbatoio_energia = (*fam)-> serbatoio_energia;
        (*fam)-> serbatoio_raccolta = (*fam)-> serbatoio_raccolta + 3;
    break;
    default:
        printf("Comando non valido\n");
  }
