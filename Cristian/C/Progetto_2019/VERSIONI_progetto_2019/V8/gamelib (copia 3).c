...
void elimina_tutte_caverne (struct Caverna *pPrimo_Elimina, struct Caverna *pUltimo_Elimina, int i, int flag_abbatti_Arvais, int flag_abbatti_Hartornen)
  {
    ...
    struct Caverna *temp_2 = pPrimo_Elimina;
    ...
    for (int a = 0; a < numero_caverne_da_eliminare; a++)
      {
        if(pPrimo_Elimina == NULL) //Non sono presenti nodi
        ...
        else
          {
            ...
            printf("RIGA 1262 PRIMA FREE. numero_caverne_da_eliminare: %hd\n", numero_caverne_da_eliminare);
          }
      }
    pPrimo_Elimina = NULL;
    ...
    if (i%2 == 0 && flag_abbatti_Arvais != 0) //Se avevo gia' abbattuto in precedenza
      {
        pPrimo_Arvais_caverna = pPrimo_Elimina;
        pUltimo_Elimina = pUltimo_Arvais_caverna;
        printf("RIGA 1264. SONO ARRIVATO QUI\n");
      }
    else if (i%2 == 0 && flag_abbatti_Arvais == 0) //Se è la prima volta che abbatto
      {
        pUltimo_Arvais_caverna = temp_2;
    ...
    else if (i%2 == 1 && flag_abbatti_Hartornen != 0) //Se avevo gia' abbattuto in precedenza
      {
        pPrimo_Hartornen_caverna =  pPrimo_Elimina;
        pUltimo_Elimina = pUltimo_Hartornen_caverna;
        printf("RIGA 1266. SONO ARRIVATO QUI\n");
      }
    else if (i%2 == 1 && flag_abbatti_Hartornen == 0) //Se è la prima volta che abbatto
      {
        pUltimo_Hartornen_caverna = temp_2;
...
int gioca (void)
  {
    ...
    elimina_tutte_caverne (pPrimo_Arvais_caverna, pUltimo_Arvais_caverna, 2, flag_abbatti_Arvais, flag_abbatti_Hartornen);
    elimina_tutte_caverne (pPrimo_Hartornen_caverna, pUltimo_Hartornen_caverna, 1, flag_abbatti_Arvais, flag_abbatti_Hartornen);
    printf("RIGA 2540. SONO ARRIVATO QUI\n");
