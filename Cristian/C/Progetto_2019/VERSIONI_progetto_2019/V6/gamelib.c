...
int gioca (void)
  {
    ...
    printf("RIGA 1765. pUltimo_Arvais_caverna: %p\n", pUltimo_Arvais_caverna);

    numero_caverne_Arvais = count (pPrimo_Arvais_caverna);
    printf("RIGA 1765. numero_caverne_Arvais: %hd\n", numero_caverne_Arvais);
    ...
    for (int a = 0; a < numero_caverne_Arvais; a++)
      {
        if(pPrimo_Arvais_caverna == NULL) //Non sono presenti nodi
        ...
        else
          {
            ...
            printf("RIGA 1766. pPrimo_Arvais_caverna: %p\n", pPrimo_Arvais_caverna);
            //printf("RIGA 1766. pPrimo_Arvais_caverna -> sinistra: %p\n", pPrimo_Arvais_caverna -> sinistra);
            //printf("RIGA 1766. pPrimo_Arvais_caverna -> avanti: %p\n"  , pPrimo_Arvais_caverna -> avanti);
            //printf("RIGA 1766. pPrimo_Arvais_caverna -> destra: %p\n"  , pPrimo_Arvais_caverna -> destra);
            printf("RIGA 1766 PRIMA FREE. pUltimo_Arvais_cavernaa: %p\n", pUltimo_Arvais_caverna);
          }
      }
    ...
    printf("RIGA 1766 DOPO FREE. pUltimo_Arvais_cavernaa: %p\n", pUltimo_Arvais_caverna);
    ...
    printf("RIGA 1770 BIS. pPrimo_Hartornen_caverna: %p\n", pPrimo_Hartornen_caverna);
    printf("RIGA 1770 BIS. pPrimo_Hartornen_caverna -> sinistra: %p\n", pPrimo_Hartornen_caverna -> sinistra);
    printf("RIGA 1770 BIS. pPrimo_Hartornen_caverna -> avanti: %p\n"  , pPrimo_Hartornen_caverna -> avanti);
    printf("RIGA 1770 BIS. pPrimo_Hartornen_caverna -> destra: %p\n"  , pPrimo_Hartornen_caverna -> destra);

    if(pUltimo_Hartornen_caverna != NULL)
      free(pUltimo_Hartornen_caverna);
    pUltimo_Hartornen_caverna = NULL;

    printf("RIGA 1770 DOPO FREE. numero_caverne_Hartornen: %hd\n", numero_caverne_Hartornen);
