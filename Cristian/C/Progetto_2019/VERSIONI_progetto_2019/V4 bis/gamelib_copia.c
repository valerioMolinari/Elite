...
int avanza (struct Caverna *pAvanza, struct Scavatrice *pPersonaggio, int i)
  {
    ...
    if(pAvanza == NULL || (pAvanza -> sinistra == NULL && pAvanza -> avanti == NULL && pAvanza -> destra == NULL)) //Non sono presenti nodi
      ...
      {
        if (((i%2 == 0 && flag_crollo_Arvais == 0) || (i%2 == 1 && flag_crollo_Hartornen == 0)) && (pAvanza -> sinistra != NULL || pAvanza -> avanti != NULL || pAvanza -> destra != NULL))
          {
                         ...
                         if (flag_crollo_Arvais == 1)
                           {
                             ...
                             printf ("RIGA 1531. primo_cunicolo_Arvais: %p\n", primo_cunicolo_Arvais);
                             ...
                             printf ("RIGA 1547. primo_cunicolo_Arvais: %p\n", primo_cunicolo_Arvais);
                             printf ("RIGA 1548. pPrimo_Arvais_caverna: %p\n", pPrimo_Arvais_caverna);
                          ...
                          if (flag_crollo_Hartornen == 1)
                            {
                              ...
                              */
                              ...
                              printf ("RIGA 1717. primo_cunicolo_Hartornen: %p\n", primo_cunicolo_Hartornen);
                              ...
                              printf ("RIGA 1719. primo_cunicolo_Hartornen: %p\n", primo_cunicolo_Hartornen);
