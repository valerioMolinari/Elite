...
/*/CALCOLO I LATI CON PITAGORA
pit1 = sqrt((temp2*temp2) + (temp3*temp3)); //IPOTENUSA
pit2 = sqrt((temp1*temp1) - (temp3*temp3)); //CAT. MAGGIORE
pit3 = sqrt((temp1*temp1) - (temp2*temp2)); //CAT. MINORE
*/
//VERIFICO CHE EFFETTIVAMENTE I LATI COMBACINO
      if (temp1 == sqrt((temp2*temp2) + (temp3*temp3)))
        {
          printf ("Il triangolo è rettangolo\n\n");
          continue;
        }

      if (temp2 == sqrt((temp1*temp1) - (temp3*temp3)))
        {
          printf ("Il triangolo è rettangolo\n\n");
          continue;
        }

      if (temp3 == sqrt((temp1*temp1) - (temp2*temp2)))
        {
          printf ("Il triangolo è rettangolo\n\n");
          continue;
        }
