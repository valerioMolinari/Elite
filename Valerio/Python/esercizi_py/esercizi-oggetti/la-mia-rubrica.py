...
#   L'unico vincolo che hai è di inserire almeno il nome e il numero
#   di telefono come stringhe.
# - Definisci un altro oggetto che rappresenti la lista dei contatti, quindi
#   sarà formato da un array di contatti.
...
#
# Variante
# Migliora i metodi di Modifica e Cancellazione, al posto di prendere in input
# l'indice dell'array passa in input il nome e ricava l'indice sul quale
# applicare l'operazione.
#
# Gestire quindi un array di oggetti prevedendo la possibilità di:
#   inserire,
#   modificare,
#   visualizzare,
#   ricercare
#   e cancellare contatti della rubrica.
